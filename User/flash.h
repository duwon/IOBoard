...
#define FLASH_FW_ADDRESS_START 0x801E800U                                                                  /*!< 업데이트 펌웨어 시작 주소 */
#define FLASH_FWINFO_ADDRESS_START 0x08037800U                                                             /*!< 업데이트 펌웨어 정보 시작 주소 */
#define FLASH_FW_PAGE_START (((FLASH_FW_ADDRESS_START - FLASH_BOOT_ADDRESS_START) / FLASH_PAGE_SIZE) - 1)  /*!< 업데이트 펌웨어 시작 페이지 */
#define FLASH_FW_PAGE_END (((FLASH_FWINFO_ADDRESS_START - FLASH_BOOT_ADDRESS_START) / FLASH_PAGE_SIZE) - 1)/*!< 업데이트 펌웨어 끝 페이지 */
