...
#define MSGCMD_CAL_WATEMETER 0x1AU
#define MSGCMD_REQUEST_CAL_VALUE 0x1BU
#define MSGCMD_UPDATE_CAL_VALUE 0x1CU
#define MSGCMD_RESET_WATEMTER_VAL 0x1DU
#define MSGCMD_CAL_WATEMETER_OFFSET 0x19U
...
#define MSGCMD_RESPONSE_CAL_VALUE 0x2BU
