...
GPIO_TypeDef *LED_PORT[LEDPORTn] = {LD_DI1_GPIO_Port, LD_DI2_GPIO_Port, LD_DI3_GPIO_Port, LD_DI4_GPIO_Port, LD_RS485RDY_GPIO_Port, LD_RS232RDY_GPIO_Port, LD_DO1_GPIO_Port, LD_DO2_GPIO_Port, LD_CC_GPIO_Port, LD_RDY_GPIO_Port};
const uint16_t LED_PIN[LEDPORTn] = {LD_DI1_Pin, LD_DI2_Pin, LD_DI3_Pin, LD_DI4_Pin, LD_RS485RDY_Pin, LD_RS232RDY_Pin, LD_DO1_Pin, LD_DO2_Pin, LD_CC_Pin, LD_RDY_Pin};
/**
  * @}
  */
